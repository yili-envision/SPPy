...
def sim(SOC_init_p, SOC_init_n, R_cell, max_conc_p, max_conc_n):
    ...
    sol = solver.solve(cycler=cycler, t_increment=1, termination_criteria = 'V')
    return sol.t, sol.V
