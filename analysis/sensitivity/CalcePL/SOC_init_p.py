...
SOC_init_p1 = 0.41
cell1 = BatteryCell(filepath_p=TEST_POS_ELEC_DIR, SOC_init_p=SOC_init_p1, func_OCP_p=funcs.OCP_ref_p,
...
SOC_init_p2 = 0.425
cell2 = BatteryCell(filepath_p=TEST_POS_ELEC_DIR, SOC_init_p=SOC_init_p2, func_OCP_p=funcs.OCP_ref_p,
                        func_dOCPdT_p=funcs.dOCPdT_p, filepath_n = TEST_NEG_ELEC_DIR, SOC_init_n=SOC_init_n,
                        func_OCP_n=funcs.OCP_ref_n, func_dOCPdT_n=funcs.dOCPdT_n,
                        filepath_electrolyte = TEST_ELECTROLYTE_DIR, filepath_cell = TEST_BATTERY_CELL_DIR, T=T)
SOC_init_p3 = 0.44
cell3 = BatteryCell(filepath_p=TEST_POS_ELEC_DIR, SOC_init_p=SOC_init_p3, func_OCP_p=funcs.OCP_ref_p,
                        func_dOCPdT_p=funcs.dOCPdT_p, filepath_n = TEST_NEG_ELEC_DIR, SOC_init_n=SOC_init_n,
                        func_OCP_n=funcs.OCP_ref_n, func_dOCPdT_n=funcs.dOCPdT_n,
                        filepath_electrolyte = TEST_ELECTROLYTE_DIR, filepath_cell = TEST_BATTERY_CELL_DIR, T=T)
...
sol1 = solver1.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"SOC_init_p={SOC_init_p1}")
cycler.reset_time_elapsed()
sol2 = solver2.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"SOC_init_p={SOC_init_p2}")
cycler.reset_time_elapsed()
sol3 = solver3.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"SOC_init_p={SOC_init_p3}")
