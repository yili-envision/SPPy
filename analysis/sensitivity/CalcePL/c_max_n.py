...
sol1 = solver1.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell1.elec_n.max_conc}")
cycler.reset_time_elapsed()
sol2 = solver2.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell2.elec_n.max_conc}")
cycler.reset_time_elapsed()
sol3 = solver3.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell3.elec_n.max_conc}")
