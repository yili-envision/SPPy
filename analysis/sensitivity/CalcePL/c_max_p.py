...
V_max = 4.2
num_cycles = 1
charge_current = np.mean(I_exp)
discharge_current = 0
rest_time = 30

# Modelling parameters
SOC_init_p, SOC_init_n = 0.9626, 0.0031
...
sol1 = solver1.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell1.elec_p.max_conc}")
cycler.reset_time_elapsed()
sol2 = solver2.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell2.elec_p.max_conc}")
cycler.reset_time_elapsed()
sol3 = solver3.solve(cycler=cycler, verbose=True, t_increment=10, sol_name=f"max_con={cell3.elec_p.max_conc}")
