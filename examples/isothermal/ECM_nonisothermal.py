...
cell = SPPy.ECMBatteryCell(R0_ref=0.005, R1_ref=0.001, C1=0.03, T_ref=298.15, Ea_R0=400, Ea_R1=400,
...
# Plots
sol.comprehensive_plot(save_dir='../../../docs/source/Assests/example_ECM_nonisothermal.png')
