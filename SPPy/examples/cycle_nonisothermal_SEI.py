...
model = SPPy.SPModel(isothermal=False, degradation=True)
SEI_model = SPPy.ROM_SEI(bCell= cell, file_path= SEI_DIR, resistance_init=1e-12)
...
solver = SPPy.SPPySolver(b_cell= cell, b_model= model, N=5, SEI_model=SEI_model)
